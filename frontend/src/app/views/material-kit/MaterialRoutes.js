...
const AppForm = Loadable(lazy(() => import('./suppliers/supplierpage')));
...
const AppDialog = Loadable(lazy(() => import('./customers/customerpage')));
const AppSnackbar = Loadable(lazy(() => import('./snackbar/AppSnackbar')));
const AppAutoComplete = Loadable(lazy(() => import('./transactions/transactionspage')));
